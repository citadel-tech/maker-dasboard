    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-400 ml-14">Configure a new maker instance</p>
        </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">A friendly name to identify this maker</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg focus:border-orange-500 focus:outline-none text-gray-100 placeholder-gray-500"
                />
                <p className="text-xs text-gray-500 mt-1">Port for the maker RPC server (each maker needs a unique port)</p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Directory where maker data will be stored</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Bitcoin Core RPC endpoint (host:port)</p>
              </div>
              ...
              <p className="text-xs text-gray-500 -mt-3">Bitcoin RPC credentials for authentication</p>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg focus:border-orange-500 focus:outline-none text-gray-100 placeholder-gray-500 font-mono text-sm"
                />
                <p className="text-xs text-gray-500 mt-1">ZeroMQ endpoint for blockchain notifications</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">Use Taproot addresses for improved privacy and lower fees</div>
                </div>
              </label>
            </div>
          </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
            ...
            <div className="bg-black rounded-lg p-4 overflow-x-auto">
              <code className="text-xs sm:text-sm text-green-400 font-mono break-all">
                ./makerd -a {formData.bitcoinUser || 'user'}:{formData.bitcoinPassword || 'password'} -r {formData.bitcoinRpc} -z {formData.zmq} -d {formData.dataDir || '~/.coinswap/maker1'} --rpc-port 127.0.0.1:{formData.rpcPort || '6103'}{formData.taproot ? ' --taproot' : ''}
              </code>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-blue-200">
              ...
              <ul className="list-disc list-inside space-y-1 text-blue-300">
                ...
                <li>ZMQ endpoint should match your Bitcoin Core configuration</li>
              </ul>
            </div>
          </div>
        </div>
