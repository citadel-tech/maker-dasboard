    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-400">Configure your maker dashboard and Bitcoin Core connection</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm text-gray-400 mb-2">Control Port</label>
                <input
                  type="number"
                  name="torControlPort"
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-2">SOCKS Port</label>
                <input
                  type="number"
                  name="torSocksPort"
                  ...
                  className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg focus:border-orange-500 focus:outline-none text-gray-100"
                />
                <p className="text-xs text-gray-500 mt-1">SOCKS port for Tor proxy</p>
              </div>
            ...
            <div className="mt-4 bg-purple-900/20 border border-purple-800/30 rounded-lg p-3">
              <p className="text-xs text-purple-400">
                🧅 <strong>Tor Network:</strong> Coinswap uses Tor for private maker discovery and communication. Make sure Tor is running.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
            <h3 className="text-lg font-semibold mb-6">Bitcoin Core RPC Configuration</h3>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Connection Settings */}
              <div className="space-y-4">
                <h4 className="text-base font-medium text-white">Connection Settings</h4>
                
                <div>
                  <label className="block text-sm text-gray-400 mb-2">RPC Host</label>
                  <input
                    type="text"
                    name="rpcHost"
                    ...
                    className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg focus:border-orange-500 focus:outline-none text-gray-100"
                  />
                  <p className="text-xs text-gray-500 mt-1">Bitcoin Core RPC host address</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg focus:border-orange-500 focus:outline-none text-gray-100"
                  />
                  <p className="text-xs text-gray-500 mt-1">8332 mainnet, 18332 testnet, 18443 regtest</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg focus:border-orange-500 focus:outline-none text-gray-100"
                  />
                  <p className="text-xs text-gray-500 mt-1">RPC username from bitcoin.conf</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg focus:border-orange-500 focus:outline-none text-gray-100"
                  />
                  <p className="text-xs text-gray-500 mt-1">RPC password from bitcoin.conf</p>
                </div>
              </div>
              
              {/* Connection Status */}
              <div className="space-y-4">
                <h4 className="text-base font-medium text-white">Connection Status</h4>
                
                <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                  <div className="flex justify-between items-center mb-3">
                    <div className="flex items-center">
                      <div className={`w-3 h-3 rounded-full mr-2 ${bitcoinStatus.connected ? 'bg-green-500' : 'bg-red-500'}`}></div>
                      <span className="text-sm text-gray-400">Connection Status</span>
                    </div>
                    <span className={`text-sm font-semibold ${bitcoinStatus.connected ? 'text-green-400' : 'text-red-400'}`}>
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-300">{bitcoinStatus.blockHeight}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Sync Progress</span>
                      <span className="text-gray-300">{bitcoinStatus.syncProgress}</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h4 className="text-base font-medium text-white">ZMQ Endpoints</h4>
                
                <div>
                  <label className="block text-sm text-gray-400 mb-2">ZMQ Raw Block</label>
                  <input
                    type="text"
                    name="zmqRawBlock"
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">ZMQ endpoint for raw block notifications</p>
                </div>
                
                <div>
                  <label className="block text-sm text-gray-400 mb-2">ZMQ Raw Transaction</label>
                  <input
                    type="text"
                    name="zmqRawTx"
                    ...
                    className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg focus:border-orange-500 focus:outline-none text-gray-100 font-mono text-sm"
                  />
                  <p className="text-xs text-gray-500 mt-1">ZMQ endpoint for raw transaction notifications</p>
                </div>
